...
of `r pop_lm$adj.r.squared`. The residuals are essentially normally 
...
build_model <- function(input_nodes, output_nodes, FLAGS) {
  use_session_with_seed(random_seed, disable_gpu = TRUE, 
...
#       FLAGS <- list('neuron1'=neuron1, 'neuron2'=neuron2, 'lr'=lr)
        ...
        # Calcualte R squared for both the training and test data so 
