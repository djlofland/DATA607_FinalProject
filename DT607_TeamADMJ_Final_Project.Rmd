...
ggplot(data = DTHD_states,
  ...
  labs(fill = "Death rate per 100,000 population",
       title = "Heart Related Deaths by State, 2000-2014") +
...
value from given features through non-linear combinations.
...
plot(history$metrics$acc, main="Model Accuracy", xlab = "epoch",
