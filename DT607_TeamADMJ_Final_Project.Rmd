...
predict the outcome, `DeathRate`. Note that there is huge co-linearity between
...
features as surrounding geographies may provide predictive value for a given
state. In a future analysis, we could explore dropping out `Region` or
`Division`.
