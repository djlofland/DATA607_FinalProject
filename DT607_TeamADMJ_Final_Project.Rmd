...
library(ggplot2)
library(data.table)
# LCD <- fread("./Data/NCHS_-_Leading_Causes_of_Death__United_States.csv")
LCD <- fread('https://data.cdc.gov/api/views/bi63-dtpu/rows.csv?accessType=DOWNLOAD&api_foundry=true')
# CD1 <- fread("./Data/nst-est2018-alldata.csv")
CD1 <- fread("https://www2.census.gov/programs-surveys/popest/datasets/2010-2018/national/totals/nst-est2018-alldata.csv")
# CD2 <- fread("./Data/st-est00int-agesex.csv")
